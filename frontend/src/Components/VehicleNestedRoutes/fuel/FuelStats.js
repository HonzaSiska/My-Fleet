...
const FuelStats = () => {
    ...
    const { volumeUnits } = useVehiclesContext()
            ...
            {   
                ...
                error ? (
                    ...
                    <>  
                        ...
                        <Card>
                            <span>Total Amount: <span className='bold'>{data.amount}</span></span><span>{` ${volumeUnits}`}</span>
                            <br />
                            <span>Total Price: <span className='bold'>{data.price}</span></span>
                        </Card>
                        <Card>
                            <span>Average Amount: <span className='bold'>{data.averageAmount}</span></span><span>{` ${volumeUnits}`}</span>
                            <br />
